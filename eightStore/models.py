...
class Toy(models.Model):
    ...
    category=models.ForeignKey(ToyCategory, on_delete=models.SET_NULL, null=True)
    type=models.CharField(max_length=10, null=True)
    def __str__(self):
        return self.title
...
class Order(models.Model):
    ...
    customerCountry = models.CharField(max_length=200, null=True)
    customerCity = models.CharField(max_length=200, null=True)
    cityPostCode = models.IntegerField(default=1000)
    customerAdress = models.CharField(max_length=500, null=True)
